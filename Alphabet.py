...
btnG=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_G,width=10,height=3,text='G',bg='orange',fg='white')\
    .grid(row=2,column=0)
btnH=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_H,width=10,height=3,text='H',bg='orange',fg='white')\
    .grid(row=2,column=1)
btnI=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_I,width=10,height=3,text='I',bg='orange',fg='white')\
    .grid(row=2,column=2)
btnJ=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_J,width=10,height=3,text='J',bg='orange',fg='white')\
    .grid(row=2,column=3)
btnK=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_K,width=10,height=3,text='K',bg='orange',fg='white')\
    .grid(row=2,column=4)
btnL=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_L,width=10,height=3,text='L',bg='orange',fg='white')\
    .grid(row=2,column=5)
...
btnN=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_N,width=10,height=3,text='N',bg='orange',fg='white')\
    .grid(row=3,column=0)
btnO=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_O,width=10,height=3,text='O',bg='orange',fg='white')\
    .grid(row=3,column=1)
btnP=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_P,width=10,height=3,text='P',bg='orange',fg='white')\
    .grid(row=3,column=2)
btnQ=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_Q,width=10,height=3,text='Q',bg='orange',fg='white')\
    .grid(row=3,column=3)
btnR=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_R,width=10,height=3,text='R',bg='orange',fg='white')\
    .grid(row=3,column=4)
btnS=Button(frame1,pady=1,bd=4,font=('arial',21,'bold'),command=Alphabet_S,width=10,height=3,text='S',bg='orange',fg='white')\
    .grid(row=3,column=5)
